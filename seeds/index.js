...
const seedDB = async () => {
  ...
  for (let i = 0; i < 50; i++) {
    ...
    const camp = new Campground({
      ...
      images: [
        {
          url: 'https://res.cloudinary.com/dfbytcndx/image/upload/v1677680760/YelpCamp/kkvqbrmzipelbxkvkyqx.jpg',
          filename: 'YelpCamp/kkvqbrmzipelbxkvkyqx',
        },
        {
          url: 'https://res.cloudinary.com/dfbytcndx/image/upload/v1677680741/YelpCamp/tdfevcldmsqwn327m8or.jpg',
          filename: 'YelpCamp/tdfevcldmsqwn327m8or',
        }
